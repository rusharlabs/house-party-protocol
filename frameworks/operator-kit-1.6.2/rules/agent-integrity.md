...
| Use the mentor's own vocabulary | ✅ | If the mentor uses "unit economics", use that term |
...
> Robust financial systems are the foundation.
...
|----------|-------------|--------|-----------|
| **SOUL-TEMPLATE.md** | your project's agent templates folder (e.g. `templates/agents/soul-template.md`) | v2.0 | The agent's living identity |
| **MEMORY-PROTOCOL.md** | your project's agent templates folder (e.g. `templates/agents/memory-template.md`) | v2.0.0 | Accumulated experience |
| **DNA-CONFIG-TEMPLATE.yaml** | your project's agent templates folder (e.g. `templates/agents/dna-config-template.yaml`) | v2.0.0 | Source configuration |
...
├── ^[RAIZ:/inbox/{PERSON}/.../{SOURCE-FILE}.txt]
