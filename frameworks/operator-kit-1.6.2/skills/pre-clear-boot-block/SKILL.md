...
|---|---|---|
| `paths.state_ssot` (e.g. `docs/plans/execution/00-STATE.md`) | Reads | open items |
...
> **Canonical boot-doc:** `docs\plans\...` · **SSoT:** `docs\plans\execution\00-STATE.md`. This file is only the shortcut.

## STEP 0 (re-verify LIVE — LC-1)
    git log --oneline -3
    # review the open items in docs\plans\execution\00-STATE.md
