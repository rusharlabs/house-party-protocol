...
Ambas herdadas do `operator-kit`, aqui empacotadas como kit standalone
...
`frameworks/supabase-pack-1.1.2/` (o diretório carrega a versão — declare-a
...
```bash
KIT=frameworks/supabase-pack-1.1.2
...
```bash
python installers/kit-forge-1.4.2/tools/skill_lint.py --all frameworks/supabase-pack-1.1.2/skills --run-proofs
```
