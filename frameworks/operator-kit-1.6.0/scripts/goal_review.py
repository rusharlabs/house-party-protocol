...
"did the OBJECTIVE deliver the promised value, LIVE?" (LC-1: green code !=
deployed != wired). Reads the acceptance-criteria
...
Usage:
    python scripts/goal_review.py --goal G-001
    python scripts/goal_review.py --prd docs/plans/_PRD/PRD-MY-GOAL.md
    python scripts/goal_review.py "python -m pytest -q" --goal G-001
