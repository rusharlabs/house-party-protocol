...
Implements the self-update trigger without ACTING on CLAUDE.md:
...
v1.0.0 - 2026-06-19 (Operator Kit - Tier 2 - self-update trigger without acting)
"""
...
def _ensure_header(capture_file: Path) -> None:
    ...
    capture_file.write_text(
        "# CAPTURED rules (verbatim) — self-update trigger\n\n"
