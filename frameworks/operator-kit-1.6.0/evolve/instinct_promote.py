...
Design: a recurring failure becomes a candidate; confidence is the recurrence count;
promotion is ALWAYS a human act (never automatic -- per partial-autonomy-slider: propose,
do not auto-execute something that persists/teaches the team).
