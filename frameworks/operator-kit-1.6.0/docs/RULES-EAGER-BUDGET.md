...
Re-measured on 2026-09-24 (operator-kit 1.6.0): EAGER 7 rules · **58.038 B** (~14.509 tokens) ·
path-scoped 123.347 B · total on disk 181.385 B. The headroom under the 59.000 B ceiling is
962 B, still smaller than the smallest scoped rule (`loop-passk`, 5.179 B).
...
- **budget** — eager bytes may not pass 59.000. The headroom above 58.038 (962 B) is smaller than
