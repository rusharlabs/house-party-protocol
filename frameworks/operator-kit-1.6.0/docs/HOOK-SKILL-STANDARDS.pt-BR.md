...
# PADRÕES OBRIGATÓRIOS PARA EXTENSÕES DO CLAUDE CODE

> **Versão:** 1.0.0
> **Criado:** 2026-01-14
> **Status:** ATIVO
> **Propósito:** Documento central de enforcement das convenções deste kit para hooks, skills, MCP e sub-agents

---

## VISÃO GERAL

Este documento define as regras OBRIGATÓRIAS deste kit para extensões do Claude Code. Toda criação ou modificação de hooks, skills, MCP configs, ou SDK sub-agents DEVE seguir estas regras.
...
- **Documentação do Claude Code (schema de hooks, settings e sub-agents):** https://docs.anthropic.com/claude-code
...
Este kit não inclui validador automático destas regras. Aplique-as na revisão usando o checklist da seção 6.

Para enforcement automático, escreva um hook PreToolUse próprio que aplique estas regras, começando em aviso (exit 1) e não em bloqueio.
