...
2. **Run the gate BEFORE applying:** `python ${CLAUDE_PLUGIN_ROOT}/scripts/done_gate.py --profile <type>` (or your project's existing eval suite). Reuse the existing runner — **do not reimplement eval**.
