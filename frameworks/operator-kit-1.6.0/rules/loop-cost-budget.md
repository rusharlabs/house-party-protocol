...
> **Origin:** registered as **LC-5**, an extension of `learned-corrections.md` (LC-1/LC-2/LC-3 + LC-4 in `stale-replay-guard.md`). Universal: applies to any autonomous loop. Counterweight to LC-2 ("do everything 100%" — but within the budget).
