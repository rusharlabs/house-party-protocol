...
│  • Local-market calibrations          │  • Processed sources                │
│                                       │                                     │
│  Examples:                            │  Examples:                          │
│  • CLOSER, CRO, CFO, CMO              │  • {PERSON-A}, {PERSON-B}           │
│                                       │                                     │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│  └─ Consult the known conflicts mapped in DNA-CONFIG.yaml                   │
...
│  └─ Person always = the same (e.g. HEUR-XX-025)                             │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│  □ Calibration specific to the local market                                 │
