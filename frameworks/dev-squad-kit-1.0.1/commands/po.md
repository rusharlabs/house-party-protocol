...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .devsquad-core/development/scripts/unified-activation-pipeline.js po
...
persona_profile:
  ...
  communication:
    ...
    signature_closing: '— Pax, balancing priorities 🎯'
...
command_availability:
  sync-story:
    ...
    description: |
      ...
      If no PM tool configured, runs `devsquad init` prompt
  pull-story:
    always_available: true
    description: |
...
3. Story templates available in `.devsquad-core/product/templates/`
