...
Re-medido em 2026-09-24 (operator-kit 1.6.1): EAGER 7 regras · **57.876 B** (~14.469 tokens) ·
com escopo de path 123.341 B · total em disco 181.217 B. A folga sob o teto de 59.000 B é de
1.124 B, ainda menor que a menor regra com escopo (`loop-passk`, 5.179 B).
...
- **estrutural** — o conjunto de regras sem `paths:` tem de ser igual ao conjunto eager
  ...
  omissão.
- **orçamento** — os bytes eager não podem passar de 59.000. A folga acima de 57.876 (1.124 B) é
