...
`frameworks/dev-squad-kit-1.1.1/` (o diretório carrega a versão — declare-a
...
```bash
KIT=frameworks/dev-squad-kit-1.1.1
...
```bash
python installers/kit-forge-1.4.2/tools/skill_lint.py --all frameworks/dev-squad-kit-1.1.1/skills --run-proofs
```
