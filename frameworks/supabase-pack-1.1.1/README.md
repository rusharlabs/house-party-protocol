...
`frameworks/supabase-pack-1.1.1/` (the directory carries the version — state it
...
```bash
KIT=frameworks/supabase-pack-1.1.1
...
```bash
python installers/kit-forge-1.4.1/tools/skill_lint.py --all frameworks/supabase-pack-1.1.1/skills --run-proofs
```
