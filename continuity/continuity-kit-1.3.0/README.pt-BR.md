...
Na distribuição emitida este módulo vive em `continuity/continuity-kit-1.3.0/` (o
diretório carrega a versão — declare-a uma vez, em `KIT`). O instalador é
`installers/kit-forge-1.4.1/kit_doctor.py` — o motor único de instalação de todo o
