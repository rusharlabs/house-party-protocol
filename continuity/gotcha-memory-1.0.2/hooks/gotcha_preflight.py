...
Scoped to the gotcha loop only (command-risk classification lives in the operator-kit's
`operation_guard_portable.py` -- this kit is just the failure->lesson->prevention
cycle). BEFORE every Bash, it derives the task_key
