...
> **Origin:** distilled from an adversarial workflow over recurring corrections in a real project — patterns that repeated in ≥3 distinct sessions, not duplicates of other rules, and actionable.
...
**Deploy/routing case (real lesson, generalized):** declaring a deploy "live" only because the
...
this happened dozens of times in a real project before this rule existed.
